...
if (typeof alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"] !== 'undefined') {
  /**
...
function addAlpineDirective() {
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].directive('repeater', function (el) {
    setTimeout(function () {
...
window.repeater = function () {
  return {
    ...
    addGroup: function addGroup(position) {
      /**
       * 0 = top
       * 1 = bottom
       */
    ...
    addFields: function addFields(index) {
      /**
    ...
    removeField: function removeField(groupIndex, fieldIndex) {
    ...
    setInitialValue: function setInitialValue() {
      ...
      this.$nextTick(function () {
        _this.$alpineLoader.classList.remove('rex-visible');
      });
    },
    groupHasFields: function groupHasFields(groupIndex) {
      return this.groups[groupIndex].hasOwnProperty('fields') && this.groups[groupIndex].fields.length > 0;
    },
    moveGroup: function moveGroup(from, to) {
      this.groups.splice(to, 0, this.groups.splice(from, 1)[0]);
      this.updateValues();
    },
    moveField: function moveField(groupIndex, from, to) {
      this.groups[groupIndex].fields.splice(to, 0, this.groups[groupIndex].fields.splice(from, 1)[0]);
      this.updateValues();
    },
    addLink: function addLink(id, groupIndex, index, fieldName) {
      var _this2 = this;
      // eslint-disable-next-line no-undef
      ...
      $(linkMap).on('rex:selectLink', function (event, linkurl, linktext) {
        if (_this2.groupHasFields(groupIndex)) {
          ...
          if (_typeof(_this2.groups[groupIndex][fieldName]) !== 'object') {
            _this2.groups[groupIndex][fieldName] = {};
          }
          _this2.groups[groupIndex][fieldName]['id'] = linkurl.replace('redaxo://', '');
          _this2.groups[groupIndex][fieldName]['name'] = linktext;
        }
        _this2.updateValues();
      });
      return false;
    },
    removeLink: function removeLink(groupIndex, index, fieldName) {
...
/******/ 	__webpack_require__.O(undefined, ["assets/css/styles"], () => (__webpack_require__("./resources/js/script.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/css/styles"], () => (__webpack_require__("./resources/css/styles.scss")))
